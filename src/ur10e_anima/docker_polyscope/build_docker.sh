...
IMAGE_NAME=epfl-lasa/ur_sim                           # Chose any name for your image (but make sure to report it in start_docker)
USE_SIMD=OFF                                              # Possible: ON, OFF
BASE_IMAGE = universalrobots/ursim_cb3   # Do not modify
